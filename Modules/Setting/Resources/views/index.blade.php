                    ...
                    <div class="card-body">
                        <form action="{{ route('settings.update') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_phone">Số điện thoại <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="default_currency_id">Loại tiền tệ<span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="default_currency_position">Vị trí tiền tệ mặc định <span class="text-danger">*</span></label>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="notification_email">Email thông báo <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="footer_text">Chân trang <span class="text-danger">*</span></label>
