        ...
        <div class="card-body">
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr class="align-middle">
                        ...
                        <th class="align-middle">
                            Số lượng <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Max Quantity: 100"></i>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        @else
                            <td colspan="3" class="text-center">
                                <span class="text-danger">Xin mời chọn 1 sản phẩm!</span>
                            </td>
                        @endif
                    </tr>
                    </tbody>
            ...
            <div class="mt-3">
                <button wire:click="generateBarcodes({{ $product }}, {{ $quantity }})" type="button" class="btn btn-primary">
                    <i class="bi bi-upc-scan"></i> Tạo mã Barcode
                </button>
            </div>
        </div>
    </div>
    ...
    @if(!empty($barcodes))
        <div class="text-right mb-3">
            <button wire:click="getPdf" wire:loading.attr="disabled" type="button" class="btn btn-primary">
                ...
                <i wire:loading.remove wire:target="getPdf" class="bi bi-file-earmark-pdf"></i> Tải PDF
            </button>
        </div>
        <div class="card">
            <div class="card-body">
